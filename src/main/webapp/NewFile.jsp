...
<div class="main">
<form action="UpdateTKCN" method="post">
<h1>TÀI KHOẢN CÁ NHÂN</h1>

<fieldset class="form-group">
						<label>Id</label> <input value="${TKCNedit.id}" type="text"
							class="form-control" name="id" required="required" readonly="readonly">
					</fieldset>

					<fieldset class="form-group">
						<label>Firstname</label> <input value="${TKCNedit.firstname}" type="text"
							class="form-control" name="firstname" required="required" >
					</fieldset>
					
					<fieldset class="form-group">
						<label>Lastname</label> <input value="${TKCNedit.lastname}" type="text"
							class="form-control" name="lastname" >
					</fieldset>

					<fieldset class="form-group">
						<label>Password</label> <input value="${TKCNedit.pass}" type="text"
							class="form-control" name="pass" required="required">
					</fieldset>
					
					<fieldset class="form-group">
						<label>Gmail</label> <input value="${TKCNedit.gmail}" type="text"
							class="form-control" name="gmail" required="required">
					</fieldset>
					
					<fieldset class="form-group">
						<label>Phone Number</label> <input value="${TKCNedit.phone}" type="text"
							class="form-control" name="phone" required="required">
					</fieldset>
					
					<fieldset class="form-group">
						<label>Address</label> <input value="${TKCNedit.address}" type="text"
