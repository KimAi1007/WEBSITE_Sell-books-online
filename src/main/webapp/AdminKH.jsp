...
<body onload="time()">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="ReadTKCN?id=${username.id}"><i class="fa fa-user-circle" aria-hidden="true"></i> TÀI KHOẢN QUẢN TRỊ</a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li ><a href="ReadCustomer" data-toggle="tooltip" data-placement="bottom"
                            title="KHÁCH HÀNG">KHÁCH HÀNG</a></li>
    ...
    <div class="container-fluid al">
        ...
        <p class="timkiemnhanvien"><b>TÌM KIẾM KHÁCH HÀNG:</b></p><Br><Br>
         ...
         <input type="text" placeholder="Tìm kiếm khách hàng..." name="txtSearchValue" value="" >
        ...
        <b>CHỨC NĂNG CHÍNH:</b><Br><a href="CreateCustomer.jsp">
