		...
		<table class="table table-bordered" id="myTable">
			...
			<tbody>
				<c:forEach var="e" items="${listSanpham}">
					...
					<tr>
						<td>${e.masach}</td>
						<td><img src="${e.hinhanh}" width="100" height="150" alt=""></td>
						<td>${e.loaisach}</td>
						<td>${e.tensach}</td>
						<td>${e.tacgia}</td>
						<td>${e.nhacungcap}</td>
						...
						<td><a class="edit" title="Sửa" data-toggle="tooltip"> <a
								href="UpdateSanpham?id=${e.masach}"> <i class="fa fa-pencil"
									aria-hidden="true"></i></a></a> 
						<a class="delete" title="Xóa" data-toggle="tooltip"> <a
								href="DeleteSanpham?masach=${e.masach}"
								onclick="showMess(${e.masach})"> <i class="fa fa-trash-o"
