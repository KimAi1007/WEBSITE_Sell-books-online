...
<body onload="time()">
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="ReadTKCN?id=${username.id}"><i class="fa fa-user-circle"
					aria-hidden="true"></i> TÀI KHOẢN QUẢN TRỊ</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="ReadCustomer" data-toggle="tooltip"
						data-placement="bottom" title="KHÁCH HÀNG">KHÁCH HÀNG</a></li>
					<li><a href="ReadSanphamADMIN" data-toggle="tooltip"
						data-placement="bottom" title="SẢN PHẨM">SẢN PHẨM</a></li>
						<li><a href="ReadLoaiSanpham" data-toggle="tooltip"
					...
					<li><a href="#" data-toggle="tooltip" data-placement="bottom"
						...
						<ul class="dropdown">
                           ...
                           <li><a href="ReadSPhome" data-toggle="tooltip" data-placement="bottom"
                                    title="View Home"><b>View Home <i class="fas fa-sign-out-alt"></i></b></a></li>
                           <li><a href="Login.jsp" data-toggle="tooltip" data-placement="bottom"
	...
	<div class="container-fluid al">
		...
		<Br>
		<Br>
		<form action="SearchLoaiSanpham" method="post">
			<input type="text" placeholder="Nhập loại sản phẩm cần tìm..."
				name="txtSearchValue" value=""> <br>
		</form>
		<b>CHỨC NĂNG CHÍNH:</b><Br>
		<a href="CreateLoaiSanpham.jsp">
			<button class="nv btn add-new" type="button" data-toggle="tooltip"
				data-placement="top" title="Thêm Loại Sản Phẩm">
		...
		<table class="table table-bordered" id="myTable">
			...
			<tbody>
				<c:forEach var="e" items="${listLoaisach}">

					<tr>
						<td>${e.idloaisach}</td>
						<td>${e.loaisach}</td>

						<td><a class="edit" title="Sửa" data-toggle="tooltip"> <a
								href="UpdateLoaiSanpham?id=${e.idloaisach}"> <i class="fa fa-pencil"
									aria-hidden="true"></i></a></a> 
				     <a class="delete" title="Xóa" data-toggle="tooltip"> <a
								href="DeleteLoaiSanpham?idloaisach=${e.idloaisach}"
								onclick="showMess(${e.idloaisach})"> <i class="fa fa-trash-o"
